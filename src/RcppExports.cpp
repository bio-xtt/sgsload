...
RcppExport SEXP _sgsload_asMatrix(SEXP rpSEXP, SEXP cpSEXP, SEXP zSEXP, SEXP nrowsSEXP, SEXP ncolsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_sgsload_asMatrix", (DL_FUNC) &_sgsload_asMatrix, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_sgsload(DllInfo *dll) {
